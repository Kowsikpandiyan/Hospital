        ...
        <div className='w-full text-center'>
          {state === 'Admin' && (
            <>
              ...
              <p>Pharmacy Login? <span className='text-primary underline cursor-pointer' onClick={() => setState('Pharmacy')}>Click here</span></p>
            </>
          )}
          {state === 'Doctor' && (
            <>
          ...
          {state === 'Pharmacy' && (
            <>
              <p>Admin Login? <span className='text-primary underline cursor-pointer' onClick={() => setState('Admin')}>Click here</span></p>
              <p>Doctor Login? <span className='text-primary underline cursor-pointer' onClick={() => setState('Doctor')}>Click here</span></p>
              <p>New Pharmacy? <span className='text-primary underline cursor-pointer' onClick={() => navigate('/pharmacy-register')}>Register here</span></p>
            </>
          )}
        </div>
      </div>
